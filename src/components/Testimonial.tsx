...
export default function Testimonial() {
  return (
    <section className="py-20 md:py-24 px-4 relative overflow-hidden">
      {/* Background Villa Image with Parallax-like feel */}
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[2rem] md:rounded-[3rem] p-8 md:p-20 shadow-2xl">
          {/* App Logo at Top */}
          <div className="flex flex-col items-center mb-10 md:mb-12">
            <div className="flex items-center gap-2 md:gap-3 mb-2">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-white rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg">
                <LayoutGrid className="text-blue-600 w-6 h-6 md:w-7 md:h-7" />
              </div>
              <span className="text-xl md:text-3xl font-bold tracking-tight text-white">LuxeRealEstate</span>
            </div>
            <div className="h-1 w-10 md:w-12 bg-blue-500 rounded-full"></div>
          </div>

          <div className="flex justify-center mb-6 md:mb-8">
            <Quote className="w-10 h-10 md:w-16 md:h-16 text-blue-400/30 fill-blue-400/10" />
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-blue-300 text-[10px] md:text-sm uppercase tracking-[0.2em] md:tracking-[0.3em] font-extrabold">Sterling Holdings</p>
          </div>
        </div>
      </div>
    </section>
